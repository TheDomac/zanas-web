...
const PrivacyModal = ({ privacyModal }: any) => {
  return (
    <Modal hasCloseButton onClose={privacyModal.setOff}>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to Zanas.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Zanas, accessible from{" "}
              <a href="https://www.zanas.net/" rel="noreferrer" target="_blank">
                https://www.zanas.net
              </a>
            </p>
          </li>
