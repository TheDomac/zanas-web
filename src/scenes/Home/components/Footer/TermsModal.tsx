...
const TermsModal = ({ termsModal }: any) => {
  return (
    <Modal hasCloseButton onClose={termsModal.setOff}>
      <ModalHeader title="Zanas Terms and Conditions of Use" />
      <ModalSection>
        <h2>1. Terms</h2>

        <p>
          By accessing this Website, accessible from https://www.zanas.net, you
        ...
        <p>
          ...
          materials on Zanas's Website for personal, non-commercial transitory
        ...
        <ul>
          ...
          <li>
            attempt to reverse engineer any software contained on Zanas's
            Website;
          </li>
          <li>
        ...
        <p>
          This will let Zanas to terminate upon violations of any of these
        ...
        <p>
          All the materials on Zanas’s Website are provided "as is". Zanas makes
          no warranties, may it be expressed or implied, therefore negates all
          other warranties. Furthermore, Zanas does not make any representations
        ...
        <p>
          Zanas or its suppliers will not be hold accountable for any damages
          that will arise with the use or inability to use the materials on
          Zanas’s Website, even if Zanas or an authorize representative of this
        ...
        <p>
          The materials appearing on Zanas’s Website may include technical,
          typographical, or photographic errors. Zanas will not promise that any
          of the materials in this Website are accurate, complete, or current.
          Zanas may change the materials contained on its Website at any time
          without notice. Zanas does not make any commitment to update the
          materials.
        </p>
        ...
        <p>
          Zanas has not reviewed all of the sites linked to its Website and is
          not responsible for the contents of any such linked site. The presence
          of any link does not imply endorsement by Zanas of the site. The use
        ...
        <p>
          Zanas may revise these Terms of Use for its Website at any time
        ...
        <p>
          Any claim related to Zanas's Website shall be governed by the laws of
          hr without regards to its conflict of law provisions.
        </p>
      </ModalSection>
    </Modal>
  );
